						...
						<div class="header_search">
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="product_search_result.php" class="header_search_form clearfix">
										<input type="text" name="searchterm" class="header_search_input" placeholder="search product by title...">
			...
			<div class="row">
				<div class="col">
					<div class="viewed_title_container">
						<h3 class="viewed_title">showing search result for  " <?= isset($_SESSION['search_query'])?$_SESSION['searchterm']:' '  ?> "</h3>
