						...
						<div class="header_search">
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="./view/product_search_result.php" class="header_search_form clearfix">
										<input type="text" name="searchterm" class="header_search_input" placeholder="Search by title">
										<div class="custom_dropdown">
											<div class="custom_dropdown_list">
												<span class="custom_dropdown_placeholder clc">All Categories</span>
												<i class="fas fa-chevron-down"></i>
												<ul class="custom_list clc">
													<li><a class="clc" href="#" select disabled>All Categories</a></li>
													...
													if ($all_cat){
															foreach ($all_cat as $value){
																	...
																	echo "<li><a class='clc' href='#'>$cat_name</a></li>";
															}
										...
										<button type="submit" name="search_query" class="header_search_button trans_300" value="Submit"><img src="images/search.png" alt=""></button>
									</form>
								</div>
							</div>
						</div>
						...
						<div class="main_nav_content d-flex flex-row">
								...
								<ul class="cat_menu">
									...
									if ($all_cat){
											foreach ($all_cat as $value){
													...
													echo "<li><a href='#'>$cat_name <i class='fas fa-chevron-right ml-auto'></i></a></li>";
											}
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
										...
										<ul>
											...
											if ($all_brand){
													foreach ($all_brand as $value){
															...
															echo "<li><a href='#'>$brand_name<i class='fas fa-chevron-down'></i></a></li>";
													}
									...
									<li><a href="./admin/index.php">Categories<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="./admin/index.php">Brand<i class="fas fa-chevron-down"></i></a></li>
										<li><a href="./view/cart.php">Cart<i class="fas fa-chevron-down"></i></a></li>

									<?php

									if(isNormalUser()){
										echo "<li><a href='./admin/index.php'> Add Product<i class='fas fa-chevron-down'></i></a></li>";
									}
